...
set(0, 'defaultuicontrolbackgroundcolor', CPBackgroundColor());
...
if (isfield(Settings,'ModuleNotes') && length(Settings.ModuleNotes) == length(Settings.ModuleNames))
    ...
    handles.Settings.ModuleNotes = cell(size(Settings.ModuleNames));
    ...
    while 1;
        ...
        elseif strncmp(output,'%filenametextVAR',16)
            ...
            handles.BrowseButton{ModuleNums}(lastVariableCheck) = uicontrol(...
                'Parent',handles.variablepanel,...
                'Units','pixels',...
                'BackgroundColor',CPForegroundColor(),...
        ...
        elseif strncmp(output,'%inputtypeVAR',13)
            ...
            if strcmp(output(19:27),'popupmenu') && ~ispc && str2double(VersionCheck(1:3)) >= 7.1
                set(handles.VariableBox{ModuleNums}(lastVariableCheck),'BackgroundColor',CPBackgroundColor());
            end
            if ~(exist('StrSet','var'))
                StrSet = cell(1);
                Count = 1;
    ...
    if isempty(get(handles.OutputFileNameEditBox,'string'))
        ...
        if ~exist(handles.Current.DefaultImageDirectory, 'dir')
            ...
            timerFig = figure('name','Status',...
                ...
                'color',CPBackgroundColor(),'UserData',userData,'Resize','off');
            ...
            text_handle = uicontrol(timerFig,'string',timertext,'style','text',...
                ...
                'FontSize',handles.Preferences.FontSize,'FontWeight','bold','BackgroundColor',CPBackgroundColor());
            ...
            PauseButton_handle = uicontrol('Style', 'pushbutton', ...
                ...
                'parent',timerFig, 'BackgroundColor',CPForegroundColor(),'FontName','Helvetica','FontSize',handles.Preferences.FontSize,'UserData',0);
            ...
            uicontrol('Style','pushbutton','String','Close','Position',[300 90 40 25],'BackgroundColor',CPForegroundColor(),...
            ...
            uicontrol('Style', 'pushbutton', ...
                ...
                'Callback', HelpButtonFunction, 'parent',timerFig, 'BackgroundColor',CPBackgroundColor());
            DetailButton=uicontrol('Style','pushbutton','String','Details','Position',[280 30 60 25],'FontName','Helvetica','FontSize',handles.Preferences.FontSize,...
                'parent',timerFig,'Tag','DetailButton','BackgroundColor',CPForegroundColor(),'Callback',[...
                ...
                '''HorizontalAlignment'', ''left'', ''BackgroundColor'', CPBackgroundColor(), ''FontSize'', TimerData.FontSize,', ...
                '''FontWeight'', ''bold'', ''String'', ''Time(sec) for:'');',...
                'uicontrol(DetWin, ''Tag'', ''DetailWindowHeader'', ''Style'', ''text'', ''Position'', [200 DetWinheight-17 51 13],', ...
                '''HorizontalAlignment'', ''center'', ''BackgroundColor'', CPBackgroundColor(), ''FontSize'', TimerData.FontSize,', ...
...
h2 = uipanel(...
    ...
    'Units','pixels',...
    'BorderType','none',...
    'ForegroundColor',CPForegroundColor(),...
    'Tag','toppanel',...
    'UserData',[],...
...
SplashScreenHandle = figure('MenuBar','None','NumberTitle','off','color',[1 1 1],'tag','SplashScreenTag','name','CellProfiler is loading...','color',[1 1 1],'Visible', 'off');
