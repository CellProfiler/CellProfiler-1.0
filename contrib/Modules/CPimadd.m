function handles = CPimadd(handles)

% Help for the CPimadd module:
...
%defaultVAR03 = AddImageName
%infotypeVAR03 = imagegroup indep
AddImageName = char(handles.Settings.VariableValues{CurrentModuleNum,3});
...
%%%%%%%%%%%%%%%%%%%%%%
drawnow
FinalImage = imadd(OrigImage1,OrigImage2);
...
handles.Pipeline.(AddImageName) = FinalImage;
