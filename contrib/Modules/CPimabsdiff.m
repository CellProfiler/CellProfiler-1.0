function handles = CPimabsdiff(handles)

% Help for the CPimabsdiff module:
...
%%%%%%%%%%%%%%%%%%%%%%
drawnow
FinalImage = imabsdiff(OrigImage1,OrigImage2);
...
handles.Pipeline.(DiffImageName) = FinalImage;
