function handles = CPimsubtract(handles)

% Help for the CPimsubtract module:
...
%defaultVAR03 = SubtractImageName
%infotypeVAR03 = imagegroup indep
SubtractImageName = char(handles.Settings.VariableValues{CurrentModuleNum,3});
...
%%%%%%%%%%%%%%%%%%%%%%
drawnow
FinalImage = imsubtract(OrigImage1,OrigImage2);
...
handles.Pipeline.(SubtractImageName) = FinalImage;
