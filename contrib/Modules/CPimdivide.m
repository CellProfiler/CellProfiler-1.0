function handles = CPimdivide(handles)

% Help for the CPimdivide module:
...
%defaultVAR03 = DivideImageName
%infotypeVAR03 = imagegroup indep
DivideImageName = char(handles.Settings.VariableValues{CurrentModuleNum,3});
...
%%%%%%%%%%%%%%%%%%%%%%
drawnow
FinalImage = imdivide(OrigImage1,OrigImage2);
...
handles.Pipeline.(DivideImageName) = FinalImage;
