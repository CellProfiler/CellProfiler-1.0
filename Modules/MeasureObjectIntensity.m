...
for i = 1:length(ObjectNameList)
    ...
    if any(findobj == ThisModuleFigureNumber);
        ...
        uicontrol(ThisModuleFigureNumber,'style','text','units','normalized', 'position', [0 0.95 1 0.04],...
            'HorizontalAlignment','center','BackgroundColor',CPBackgroundColor(),'fontname','Helvetica','tag','TextUIControl',...
        ...
        uicontrol(ThisModuleFigureNumber,'style','text','units','normalized', 'position', [0.05 0.85 0.3 0.03],...
            'HorizontalAlignment','left','BackgroundColor',CPBackgroundColor(),'fontname','Helvetica','tag','TextUIControl',...
        ...
        uicontrol(ThisModuleFigureNumber,'style','text','units','normalized', 'position', [0.35+0.1*(columns-1) 0.9 0.1 0.03],...
            'HorizontalAlignment','center','BackgroundColor',CPBackgroundColor(),'fontname','Helvetica','tag','TextEachObjUIEachOControl',...
        ...
        uicontrol(ThisModuleFigureNumber,'style','text','units','normalized', 'position', [0.35+0.1*(columns-1) 0.85 0.1 0.03],...
            'HorizontalAlignment','center','BackgroundColor',CPBackgroundColor(),'fontname','Helvetica','tag','TextEachObjUIControl',...
