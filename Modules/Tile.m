...
if SetBeingAnalyzed == NumberOfImageSets
    ...
    if any(findobj == ThisModuleFigureNumber)
        ...
        uicontrol('Style', 'pushbutton', ...
            'String', 'Hide', 'Position', [10 6 45 20], 'BackgroundColor',CPBackgroundColor(),...
        ...
        if ~isdeployed
            ...
            uicontrol('Style', 'pushbutton', ...
                'String', 'Change', 'Position', [60 6 45 20],'BackgroundColor',CPBackgroundColor(), ...
        ...
        ToggleFileNamesButtonFunction = ...
            ...
            'clear Handles button'];
        uicontrol('Style', 'pushbutton', ...
            'String', 'Show', 'Position', [120 6 45 20], 'BackgroundColor',CPBackgroundColor(),...
        ...
        if ~isdeployed
            ...
            uicontrol('Style', 'pushbutton', 'BackgroundColor',CPBackgroundColor(),...
            ...
            uicontrol('Style', 'pushbutton', ...
                'String', 'Change', 'Position', [230 6 45 20], 'BackgroundColor',CPBackgroundColor(),...
        ...
        HiResFunction = ['Oldtitle = get(get(gca,''title''),''string'');'...
            ...
            'FigHandle = figure(''color'',CPBackgroundColor(),''position'',[Left Bottom 250 442]);'...
        ...
        uicontrol('Style', 'pushbutton', ...
            'String', 'HI-RES', 'Position', [290 6 55 20], 'BackgroundColor',CPBackgroundColor(),...
