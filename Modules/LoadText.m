...
if handles.Current.SetBeingAnalyzed == handles.Current.StartingImageSet
    ...
    if any(findobj == ThisModuleFigureNumber)
        ...
        uicontrol('style','text','units','normalized','HorizontalAlignment','left','string',['Description: ',Description],'position',[.05 .55 .8 .4],'BackgroundColor',CPBackgroundColor())
        uicontrol('style','text','units','normalized','HorizontalAlignment','left','string',['Text: ',Text'],'position',[.05 .1 1 .7],'BackgroundColor',CPBackgroundColor())
    end
end