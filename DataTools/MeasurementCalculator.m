...
uicontrol(Window,'style','text','String','Calculate','Fontweight','bold',...
    'FontSize',FontSize,'units','inches','position',[0 BaseY Width uiheight],'backgroundcolor',CPBackgroundColor());

%%% FEATURE 1
BaseY = BaseY - uiheight;
uicontrol(Window,'style','text','String','A feature:','Fontweight','bold','horizontalalignment','left',...
    'FontSize',FontSize,'units','inches','position',[0.1 BaseY 1 uiheight],'backgroundcolor',CPBackgroundColor());
BaseY = BaseY - uiheight;
uicontrol(Window,'style','pushbutton','String','Get feature','BackGroundColor',CPBackgroundColor(),'FontSize',FontSize,'units','inches',...
...
Operation1 = uicontrol(Window,'Style','popupmenu','String',{'multiplied','divided'},'FontSize',FontSize,...
    'backgroundcolor',CPBackgroundColor(),'units','inches','position',[1.1 BaseY 1.3 uiheight]);
Operation2 = uicontrol(Window,'Style','popupmenu','String',{'objectwise by','by the image mean of','by the image median of'},...
    'backgroundcolor',CPBackgroundColor(),'FontSize',FontSize,'units','inches','position',[2.5 BaseY 2.1 uiheight]);

%%% FEATURE 2
BaseY = BaseY - uiheight*1.5;
uicontrol(Window,'style','text','String','another feature:','Fontweight','bold','horizontalalignment','left',...
    'FontSize',FontSize,'units','inches','position',[0.1 BaseY 2 uiheight],'backgroundcolor',CPBackgroundColor());
BaseY = BaseY - uiheight;
uicontrol(Window,'style','pushbutton','String','Get feature','BackGroundColor',CPBackgroundColor(),'FontSize',FontSize,'units','inches',...
    'position',[0.1 BaseY 0.9 uiheight],'Callback',...
    ['[cobj,cfig] = gcbo;',...
...
uicontrol(Window,'style','text','String','Name your new measurement:','Fontweight','bold','horizontalalignment','left',...
    'FontSize',FontSize,'units','inches','position',[0.1 BaseY+uiheight 3.5 uiheight],'backgroundcolor',CPBackgroundColor());
...
uicontrol(Window,'style','text','String','Associate this measurement with:','Fontweight','bold','horizontalalignment','left',...
    'FontSize',FontSize,'units','inches','position',[0.1 BaseY 2.5 uiheight],'backgroundcolor',CPBackgroundColor());
SaveLocation = uicontrol(Window,'Style','popupmenu','string',{'',''},'FontSize',FontSize,...
    'backgroundcolor',CPBackgroundColor(),'units','inches','position',[2.6 BaseY 1.8 uiheight]);
...
uicontrol(Window,'style','pushbutton','String','?','FontSize',FontSize,...
    'HorizontalAlignment','center','units','inches','position',[4.4 BaseY 0.2 uiheight],'BackgroundColor',CPBackgroundColor(),'FontWeight', 'bold',...
...
calculatebutton = uicontrol(Window,'style','pushbutton','String','Calculate','Fontweight','bold','FontSize',FontSize,'units','inches',...
    'position',[posx 0.1 0.75 0.3],'Callback','[cobj,cfig] = gcbo;set(cobj,''UserData'',1);uiresume(cfig);clear cobj cfig;','BackgroundColor',CPBackgroundColor());
