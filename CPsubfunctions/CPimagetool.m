...
if ~isempty(varargin)
        ...
        switch action
            ...
            case {'ChangeColormap'}                         % Change colormap of the whole figure
                ...
                if ~isempty(ChangeColormapHandle)
                    ...
                    % Create buttons
                    FigureText         = uicontrol(ChangeColormapHandle,'style','text','units','normalized','position',[.05 .8 .9 .15],'string',Title,'BackgroundColor',CPBackgroundColor(),'FontSize',FontSize,'FontWeight','bold','Tag','FigureText');
                    SelectColormapText = uicontrol(ChangeColormapHandle,'style','text','units','normalized','position',[.055 .36 .56 .4],'string','Please specify the colormap to use.   Note: this will have effect in the whole figure, not just the selected image.','BackgroundColor',CPBackgroundColor(),'FontSize',FontSize,'HorizontalAlignment','left');
                    %SelectColormapText = uicontrol(ChangeColormapHandle,'style','text','units','normalized','position',[.055 .36 .56 .4],'string','Please specify the colormap to use.   Note: this will have effect in the whole figure, not just the selected image.','BackgroundColor',CPBackgroundColor(),'FontSize',FontSize,'HorizontalAlignment','left');
                    OpenEditorButton   = uicontrol(ChangeColormapHandle,'style','pushbutton','units','normalized','position',[.685 .33 .26 .2],'string','Open Editor','BackgroundColor',CPBackgroundColor(),'FontSize',FontSize,'Tag','OpenEditorButton','UserData',FigureHandle,'Callback',OpenEditorCallback);
                    ApplyToAllButton   = uicontrol(ChangeColormapHandle,'style','pushbutton','units','normalized','position',[.685 .075 .26 .2],'string','Apply To All','BackgroundColor',CPBackgroundColor(),'FontSize',FontSize,'Tag','ApplyAllButton','UserData',ButtonData,'Callback',ApplyAllCallback);
                    ApplyButton        = uicontrol(ChangeColormapHandle,'style','pushbutton','units','normalized','position',[.405 .075 .26 .2],'string','Apply','BackgroundColor',CPBackgroundColor(),'FontSize',FontSize,'Tag','ApplyButton','UserData',ButtonData,'Callback',ApplyCallback);
                    CloseButton        = uicontrol(ChangeColormapHandle,'style','pushbutton','units','normalized','position',[.125 .075 .26 .2],'string','Close','BackgroundColor',CPBackgroundColor(),'FontSize',FontSize,'Callback',CloseCallback);
                    HelpButton         = uicontrol(ChangeColormapHandle,'style','pushbutton','units','normalized','position',[.055 .075 .05 .2],'string','?','BackgroundColor',CPBackgroundColor(),'FontSize',FontSize,'Callback',HelpCallback);
                    uicontrol(ChangeColormapHandle,'Style','popupmenu','Units','normalized','Position',[0.685 0.55 .26 .2],'String',{'default' 'autumn' 'bone' 'colorcube' 'cool' 'copper' 'flag' 'gray' 'hot' 'hsv' 'jet' 'lines' 'pink' 'prism' 'spring' 'summer' 'white' 'winter'},'BackgroundColor',CPBackgroundColor(),'FontSize',FontSize,'Tag','ChangeColormapPopupMenu','Value',1);
    ...
    if ~isempty(ImageToolWindowHandle)
        ...
        % Create buttons
        Text = uicontrol(ImageToolWindowHandle,'style','text','units','normalized','position',[.03 .85 .95 .12],'string',Title,'BackgroundColor',CPBackgroundColor(),'FontSize',FontSize);
        NewWindow =      uicontrol(ImageToolWindowHandle,'style','pushbutton','units','normalized','position',[.05 .78 .9 .1],'string','Open in new window','BackgroundColor',CPBackgroundColor(),'FontSize',FontSize);
        Histogram =      uicontrol(ImageToolWindowHandle,'style','pushbutton','units','normalized','position',[.05 .66 .9 .1],'string','Show intensity histogram','Tag','Histogram','BackgroundColor',CPBackgroundColor(),'FontSize',FontSize);
        MeasureLength =  uicontrol(ImageToolWindowHandle,'style','pushbutton','units','normalized','position',[.05 .54 .9 .1],'string','Measure Length','Tag','MeasureLength','BackgroundColor',CPBackgroundColor(),'FontSize',FontSize);
        ChangeColormap = uicontrol(ImageToolWindowHandle,'style','pushbutton','units','normalized','position',[.05 .42 .9 .1],'string','Change Colormap','Tag','ChangeColormap','BackgroundColor',CPBackgroundColor(),'FontSize',FontSize);
        MatlabWS  =      uicontrol(ImageToolWindowHandle,'style','pushbutton','units','normalized','position',[.05 .30 .9 .1],'string','Save to work space','BackgroundColor',CPBackgroundColor(),'FontSize',FontSize);
        SaveImageAs=     uicontrol(ImageToolWindowHandle,'style','pushbutton','units','normalized','position',[.05 .18 .9 .1],'string','Save to hard drive','BackgroundColor',CPBackgroundColor(),'FontSize',FontSize);
        Cancel    =      uicontrol(ImageToolWindowHandle,'style','pushbutton','units','normalized','position',[.25 .05 .7 .1],'string','Cancel','BackgroundColor',CPBackgroundColor(),'FontSize',FontSize);
        Help    =        uicontrol(ImageToolWindowHandle,'style','pushbutton','units','normalized','position',[.05 .05 .15 .1],'string','?','BackgroundColor',CPBackgroundColor(),'FontSize',FontSize);
